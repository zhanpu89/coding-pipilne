...
OpenCode AI 技能集合 —— 11 个指导 AI 代理完成软件工程各阶段的指令集。
...
| **ai-memory** | 经验引擎（贯穿 pipeline 注智） | `call_ai_memory` |
...
| 插件 | 文件 | 职责 |
|------|------|------|
| 技能编排 | `plugins/skill-agent.ts` | 将 11 个技能暴露为 `call_*` 自定义工具，负责 SKILL.md 懒加载和 subagent 调度 |
